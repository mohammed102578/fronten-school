...
<template>
  ...
  <CardBox :class="cardClass" is-form @submit.prevent="add_parent"  enctype="multipart/form-data">
    ...
    <div v-if="success_message == true"
      ...
      <BaseButtons style="margin:5px">
        ...
        <BaseButton :icon="mdiContentSave"  type="submit" color="info" label="Create Guardian" />
...
methods: {
  ...
  async add_parent() {
    ...
    formData.append("Address_Mother",this.Address_Mother);
        const response = await axios.post('http://localhost:8000/Api/add_parent',formData,
          {
            headers: {
              'auth_token': this.userData.user.api_token,
              'api_password': "ase1iXcLAxanvXLZcgh6tk",
    ...
    this.v$.Name_Father_ar.$errors[0].$message = " "
    this.v$.Name_Father_en.$errors[0].$message = " "
    this.v$.National_ID_Father.$errors[0].$message = " "
    this.v$.email_Father.$errors[0].$message = " "
    this.v$.password.$errors[0].$message = " "
    this.v$.password_confirm.$errors[0].$message = " "
    this.v$.Passport_ID_Father.$errors[0].$message = " "
    this.v$.Phone_Father.$errors[0].$message = " "
    this.v$.Job_Father.$errors[0].$message = " "
    this.v$.Nationality_Father_id.$errors[0].$message = " "
    this.v$.Blood_Type_Father_id.$errors[0].$message = " "
    this.v$.Religion_Father_id.$errors[0].$message = " "
    this.v$.Address_Father.$errors[0].$message = " "
    this.v$.Name_Mother_ar.$errors[0].$message = " "
    this.v$.Name_Mother_en.$errors[0].$message = " "
    this.v$.National_ID_Mother.$errors[0].$message = " "
    this.v$.Passport_ID_Mother.$errors[0].$message = " "
    this.v$.Phone_Mother.$errors[0].$message = " "
    this.v$.Job_Mother.$errors[0].$message = " "
    this.v$.Nationality_Mother_id.$errors[0].$message = " "
    this.v$.Blood_Type_Mother_id.$errors[0].$message = " "
    this.v$.Religion_Mother_id.$errors[0].$message = " "
    this.v$.Address_Mother.$errors[0].$message = " "
