...
<template>
  ...
  <CardBox :class="cardClass" is-form @submit.prevent="add_teacher"  enctype="multipart/form-data">
    ...
    <div v-if="success_message == true"
      ...
      <div v-if="error_message.length > 0"
        ...
        <div v-if="step === 1">
        <h2><b style="color:crimson;margin:3px">{{ $t('First Step') }}</b> <i style="color:rgb(192, 65, 90)">{{$t('Personal Info')}}</i></h2>
      ...
      <div v-if="step === 2">
        <h2><b style="color:crimson;margin:3px">{{ $t('Second Step') }}</b> <i style="color:rgb(192, 65, 90)">{{ $t('Teacher Info') }}</i></h2>
        <FormField style="width: 49%;display: inline-block;margin: 5px;">
      ...
      <BaseButtons style="margin:5px">
        ...
        <BaseButton :icon="mdiContentSave"  type="submit" color="info" label="Create Teacher" />
...
methods: {
  ...
  async add_teacher() {
    ...
    this.v$.National_ID.$errors[0].$message = " "
    this.v$.email_Teacher.$errors[0].$message = " "
    this.v$.password.$errors[0].$message = " "
    this.v$.password_confirm.$errors[0].$message = " "
    this.v$.Joining_Date.$errors[0].$message = " "
    this.v$.phone.$errors[0].$message = " "
    this.v$.Nationality_id.$errors[0].$message = " "
    this.v$.Blood_Type_id.$errors[0].$message = " "
    this.v$.Religion_id.$errors[0].$message = " "
    this.v$.gender_id.$errors[0].$message = " "
    this.v$.specialization_id.$errors[0].$message = " "
    this.v$.address.$errors[0].$message = " "
    this.v$.bank_account.$errors[0].$message = " "
